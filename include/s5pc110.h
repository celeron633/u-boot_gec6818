...
#define OMR_REG				__REG(PRO_ID_BASE+OMR_OFFSET)
...
#define MP01_BASE		(ELFIN_GPIO_BASE + 0x2E0)
#define MP02_BASE		(ELFIN_GPIO_BASE + 0x300)
#define MP03_BASE		(ELFIN_GPIO_BASE + 0x320)
#define MP04_BASE		(ELFIN_GPIO_BASE + 0x340)
#define MP05_BASE		(ELFIN_GPIO_BASE + 0x360)
#define MP06_BASE		(ELFIN_GPIO_BASE + 0x380)
#define MP07_BASE		(ELFIN_GPIO_BASE + 0x3A0)
#define MP10_BASE		(ELFIN_GPIO_BASE + 0x3C0)
#define MP11_BASE		(ELFIN_GPIO_BASE + 0x3E0)
#define MP12_BASE		(ELFIN_GPIO_BASE + 0x400)
#define MP13_BASE		(ELFIN_GPIO_BASE + 0x420)
#define MP14_BASE		(ELFIN_GPIO_BASE + 0x440)
#define MP15_BASE		(ELFIN_GPIO_BASE + 0x460)
#define MP16_BASE		(ELFIN_GPIO_BASE + 0x480)
#define MP17_BASE		(ELFIN_GPIO_BASE + 0x4A0)
#define MP18_BASE		(ELFIN_GPIO_BASE + 0x4C0)
#define MP20_BASE		(ELFIN_GPIO_BASE + 0x4E0)
#define MP21_BASE		(ELFIN_GPIO_BASE + 0x500)
#define MP22_BASE		(ELFIN_GPIO_BASE + 0x520)
#define MP23_BASE		(ELFIN_GPIO_BASE + 0x540)
#define MP24_BASE		(ELFIN_GPIO_BASE + 0x560)
#define MP25_BASE		(ELFIN_GPIO_BASE + 0x580)
#define MP26_BASE		(ELFIN_GPIO_BASE + 0x5A0)
#define MP27_BASE		(ELFIN_GPIO_BASE + 0x5C0)
#define MP28_BASE		(ELFIN_GPIO_BASE + 0x5E0)
#define ETC0_BASE		(ELFIN_GPIO_BASE + 0x600)
#define ETC1_BASE		(ELFIN_GPIO_BASE + 0x620)
#define ETC2_BASE		(ELFIN_GPIO_BASE + 0x640)
#define ETC4_BASE		(ELFIN_GPIO_BASE + 0x660)

#define MP01CON			(MP01_BASE + 0x00)
#define MP01DAT			(MP01_BASE + 0x04)
#define MP01PUD			(MP01_BASE + 0x08)
#define MP01DRV			(MP01_BASE + 0x0c)
#define MP01CONPDN		(MP01_BASE + 0x10)
#define MP01PUDPDN		(MP01_BASE + 0x14)

#define MP02CON			(MP02_BASE + 0x00)
#define MP02DAT			(MP02_BASE + 0x04)
#define MP02PUD			(MP02_BASE + 0x08)
#define MP02DRV			(MP02_BASE + 0x0c)
#define MP02CONPDN		(MP02_BASE + 0x10)
#define MP02PUDPDN		(MP02_BASE + 0x14)

#define MP03CON			(MP03_BASE + 0x00)
#define MP03DAT			(MP03_BASE + 0x04)
#define MP03PUD			(MP03_BASE + 0x08)
#define MP03DRV			(MP03_BASE + 0x0c)
#define MP03CONPDN		(MP03_BASE + 0x10)
#define MP03PUDPDN		(MP03_BASE + 0x14)

#define MP04CON			(MP04_BASE + 0x00)
#define MP04DAT			(MP04_BASE + 0x04)
#define MP04PUD			(MP04_BASE + 0x08)
#define MP04DRV			(MP04_BASE + 0x0c)
#define MP04CONPDN		(MP04_BASE + 0x10)
#define MP04PUDPDN		(MP04_BASE + 0x14)

#define MP05CON			(MP05_BASE + 0x00)
#define MP05DAT			(MP05_BASE + 0x04)
#define MP05PUD			(MP05_BASE + 0x08)
#define MP05DRV			(MP05_BASE + 0x0c)
#define MP05CONPDN		(MP05_BASE + 0x10)
#define MP05PUDPDN		(MP05_BASE + 0x14)

#define MP06CON			(MP06_BASE + 0x00)
#define MP06DAT			(MP06_BASE + 0x04)
#define MP06PUD			(MP06_BASE + 0x08)
#define MP06DRV			(MP06_BASE + 0x0c)
#define MP06CONPDN		(MP06_BASE + 0x10)
#define MP06PUDPDN		(MP06_BASE + 0x14)

#define MP07CON			(MP07_BASE + 0x00)
#define MP07DAT			(MP07_BASE + 0x04)
#define MP07PUD			(MP07_BASE + 0x08)
#define MP07DRV			(MP07_BASE + 0x0c)
#define MP07CONPDN		(MP07_BASE + 0x10)
#define MP07PUDPDN		(MP07_BASE + 0x14)

#define MP10CON			(MP10_BASE + 0x00)
#define MP10DAT			(MP10_BASE + 0x04)
#define MP10PUD			(MP10_BASE + 0x08)
#define MP10DRV			(MP10_BASE + 0x0c)
#define MP10CONPDN		(MP10_BASE + 0x10)
#define MP10PUDPDN		(MP10_BASE + 0x14)

#define MP11CON			(MP11_BASE + 0x00)
#define MP11DAT			(MP11_BASE + 0x04)
#define MP11PUD			(MP11_BASE + 0x08)
#define MP11DRV			(MP11_BASE + 0x0c)
#define MP11CONPDN		(MP11_BASE + 0x10)
#define MP11PUDPDN		(MP11_BASE + 0x14)

#define MP12CON			(MP12_BASE + 0x00)
#define MP12DAT			(MP12_BASE + 0x04)
#define MP12PUD			(MP12_BASE + 0x08)
#define MP12DRV			(MP12_BASE + 0x0c)
#define MP12CONPDN		(MP12_BASE + 0x10)
#define MP12PUDPDN		(MP12_BASE + 0x14)

#define MP13CON			(MP13_BASE + 0x00)
#define MP13DAT			(MP13_BASE + 0x04)
#define MP13PUD			(MP13_BASE + 0x08)
#define MP13DRV			(MP13_BASE + 0x0c)
#define MP13CONPDN		(MP13_BASE + 0x10)
#define MP13PUDPDN		(MP13_BASE + 0x14)

#define MP14CON			(MP14_BASE + 0x00)
#define MP14DAT			(MP14_BASE + 0x04)
#define MP14PUD			(MP14_BASE + 0x08)
#define MP14DRV			(MP14_BASE + 0x0c)
#define MP14CONPDN		(MP14_BASE + 0x10)
#define MP14PUDPDN		(MP14_BASE + 0x14)

#define MP15CON			(MP15_BASE + 0x00)
#define MP15DAT			(MP15_BASE + 0x04)
#define MP15PUD			(MP15_BASE + 0x08)
#define MP15DRV			(MP15_BASE + 0x0c)
#define MP15CONPDN		(MP15_BASE + 0x10)
#define MP15PUDPDN		(MP15_BASE + 0x14)

#define MP16CON			(MP16_BASE + 0x00)
#define MP16DAT			(MP16_BASE + 0x04)
#define MP16PUD			(MP16_BASE + 0x08)
#define MP16DRV			(MP16_BASE + 0x0c)
#define MP16CONPDN		(MP16_BASE + 0x10)
#define MP16PUDPDN		(MP16_BASE + 0x14)

#define MP17CON			(MP17_BASE + 0x00)
#define MP17DAT			(MP17_BASE + 0x04)
#define MP17PUD			(MP17_BASE + 0x08)
#define MP17DRV			(MP17_BASE + 0x0c)
#define MP17CONPDN		(MP17_BASE + 0x10)
#define MP17PUDPDN		(MP17_BASE + 0x14)

#define MP18CON			(MP18_BASE + 0x00)
#define MP18DAT			(MP18_BASE + 0x04)
#define MP18PUD			(MP18_BASE + 0x08)
#define MP18DRV			(MP18_BASE + 0x0c)
#define MP18CONPDN		(MP18_BASE + 0x10)
#define MP18PUDPDN		(MP18_BASE + 0x14)

#define MP20CON			(MP20_BASE + 0x00)
#define MP20DAT			(MP20_BASE + 0x04)
#define MP20PUD			(MP20_BASE + 0x08)
#define MP20DRV			(MP20_BASE + 0x0c)
#define MP20CONPDN		(MP20_BASE + 0x10)
#define MP20PUDPDN		(MP20_BASE + 0x14)

#define MP21CON			(MP21_BASE + 0x00)
#define MP21DAT			(MP21_BASE + 0x04)
#define MP21PUD			(MP21_BASE + 0x08)
#define MP21DRV			(MP21_BASE + 0x0c)
#define MP21CONPDN		(MP21_BASE + 0x10)
#define MP21PUDPDN		(MP21_BASE + 0x14)

#define MP22CON			(MP22_BASE + 0x00)
#define MP22DAT			(MP22_BASE + 0x04)
#define MP22PUD			(MP22_BASE + 0x08)
#define MP22DRV			(MP22_BASE + 0x0c)
#define MP22CONPDN		(MP22_BASE + 0x10)
#define MP22PUDPDN		(MP22_BASE + 0x14)

#define MP23CON			(MP23_BASE + 0x00)
#define MP23DAT			(MP23_BASE + 0x04)
#define MP23PUD			(MP23_BASE + 0x08)
#define MP23DRV			(MP23_BASE + 0x0c)
#define MP23CONPDN		(MP23_BASE + 0x10)
#define MP23PUDPDN		(MP23_BASE + 0x14)

#define MP24CON			(MP24_BASE + 0x00)
#define MP24DAT			(MP24_BASE + 0x04)
#define MP24PUD			(MP24_BASE + 0x08)
#define MP24DRV			(MP24_BASE + 0x0c)
#define MP24CONPDN		(MP24_BASE + 0x10)
#define MP24PUDPDN		(MP24_BASE + 0x14)

#define MP25CON			(MP25_BASE + 0x00)
#define MP25DAT			(MP25_BASE + 0x04)
#define MP25PUD			(MP25_BASE + 0x08)
#define MP25DRV			(MP25_BASE + 0x0c)
#define MP25CONPDN		(MP25_BASE + 0x10)
#define MP25PUDPDN		(MP25_BASE + 0x14)

#define MP26CON			(MP26_BASE + 0x00)
#define MP26DAT			(MP26_BASE + 0x04)
#define MP26PUD			(MP26_BASE + 0x08)
#define MP26DRV			(MP26_BASE + 0x0c)
#define MP26CONPDN		(MP26_BASE + 0x10)
#define MP26PUDPDN		(MP26_BASE + 0x14)

#define MP27CON			(MP27_BASE + 0x00)
#define MP27DAT			(MP27_BASE + 0x04)
#define MP27PUD			(MP27_BASE + 0x08)
#define MP27DRV			(MP27_BASE + 0x0c)
#define MP27CONPDN		(MP27_BASE + 0x10)
#define MP27PUDPDN		(MP27_BASE + 0x14)

#define MP28CON			(MP28_BASE + 0x00)
#define MP28DAT			(MP28_BASE + 0x04)
#define MP28PUD			(MP28_BASE + 0x08)
#define MP28DRV			(MP28_BASE + 0x0c)
#define MP28CONPDN		(MP28_BASE + 0x10)
#define MP28PUDPDN		(MP28_BASE + 0x14)

#define ETC0PUD			(ETC0_BASE + 0x08)
#define ETC0DRV			(ETC0_BASE + 0x0c)

#define ETC1PUD			(ETC1_BASE + 0x08)
#define ETC1DRV			(ETC1_BASE + 0x0c)

#define ETC2PUD			(ETC2_BASE + 0x08)
#define ETC2DRV			(ETC2_BASE + 0x0c)

#define ETC4PUD			(ETC4_BASE + 0x08)
#define ETC4DRV			(ETC4_BASE + 0x0c)
