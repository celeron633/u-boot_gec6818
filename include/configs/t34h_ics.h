...
#define	CFG_MEMTEST_SCRATCH 0xC0000000
...
#define CONFIG_T34_PVT		0	/*T34 PVT board*/
#define CONFIG_T34_H		1	/*T34 PVT board*/
...
#define MEMORY_BASE_ADDRESS	0x20000000 //yan
...
//#define CONFIG_CLK_800_200_166_133	//qdk 800MHz
...
//#define CONFIG_CLK_1400_200_166_133
...
#define	APLL_MDIV	150
#define	APLL_PDIV	0x03
#define	APLL_SDIV	0x01
#elif defined(CONFIG_CLK_1400_200_166_133)
...
#define CLK_DIV0_VAL    ((0<<APLL_RATIO)|(4<<A2M_RATIO)|(4<<HCLK_MSYS_RATIO)|(1<<PCLK_MSYS_RATIO)\
			|(3<<HCLK_DSYS_RATIO)|(1<<PCLK_DSYS_RATIO)|(4<<HCLK_PSYS_RATIO)|(1<<PCLK_PSYS_RATIO))
#elif defined(CONFIG_CLK_1200_200_166_133)
//qdk1226--#define CLK_DIV0_VAL    ((0<<APLL_RATIO)|(5<<A2M_RATIO)|(5<<HCLK_MSYS_RATIO)|(1<<PCLK_MSYS_RATIO)\
//			|(3<<HCLK_DSYS_RATIO)|(1<<PCLK_DSYS_RATIO)|(4<<HCLK_PSYS_RATIO)|(1<<PCLK_PSYS_RATIO))
//qdk1226++
//run 600MHz in bootloader
#define CLK_DIV0_VAL    ((1<<APLL_RATIO)|(5<<A2M_RATIO)|(2<<HCLK_MSYS_RATIO)|(1<<PCLK_MSYS_RATIO)\
			|(3<<HCLK_DSYS_RATIO)|(1<<PCLK_DSYS_RATIO)|(4<<HCLK_PSYS_RATIO)|(1<<PCLK_PSYS_RATIO))
#elif defined(CONFIG_CLK_1400_200_166_133)
#define CLK_DIV0_VAL    ((0<<APLL_RATIO)|(4<<A2M_RATIO)|(4<<HCLK_MSYS_RATIO)|(1<<PCLK_MSYS_RATIO)\
			|(3<<HCLK_DSYS_RATIO)|(1<<PCLK_DSYS_RATIO)|(4<<HCLK_PSYS_RATIO)|(1<<PCLK_PSYS_RATIO))
...
#error "You should define memory type (AC type or H type or B type)"
	...
	defined(CONFIG_CLK_1400_200_166_133)
...
#define DMC0_TIMING_ROW		0x1A233309	// TimingRow	for @200MHz
#define DMC0_TIMING_DATA	0x23240304	// TimingData	CL=3
#define	DMC0_TIMING_PWR		0x08280111	// TimingPower
...
#define CFG_FASTBOOT_TRANSFER_BUFFER_SIZE	(0x12000000)   /* 128MB + 64MB ywb+*/
#define CFG_FASTBOOT_ADDR_KERNEL		(0xC0008000)
#define CFG_FASTBOOT_ADDR_RAMDISK		(0x30B00000)
...
#define CFG_LCD_FBUFFER				(0x3D000000)

#define CONFIG_BOOTDELAY	0
#if defined(CFG_FASTBOOT_NANDBSP)
#define CONFIG_BOOTCOMMAND	"nand read C0008000 600000 400000; nand read 28800000 B00000 180000; bootm C0008000 28800000"
#elif defined(CFG_FASTBOOT_SDMMCBSP)
#define CONFIG_BOOTCOMMAND	"movi read kernel C0008000; movi read rootfs 30B00000 300000; bootm C0008000 30B00000"
#endif
