...
#define MEMORY_BASE_ADDRESS	0x30000000 //yan
...
#if defined(CONFIG_MCP_SINGLE)
#if CONFIG_T34_H	//Same with Lenovo C110 N-type
...
#else
#define DMC0_MEMCONFIG_0	0x30F01313	//0x20E01323//yan MemConfig0	256MB config, 8 banks,Mapping Method[12:15]0:linear, 1:linterleaved, 2:Mixed
...
#define SDRAM_BANK_SIZE         0x10000000    /* 256 MB yan*/
...
#define CFG_FASTBOOT_TRANSFER_BUFFER_SIZE	(0xC000000)   /* 192MB */
...
#define CONFIG_BOOTCOMMAND	"nand read C0008000 600000 400000; nand read 30b00000 B00000 300000; bootm C0008000 30b00000"
...
#define	SDMMC_SYSTEM_PART_SIZE		(140*1024*1024)
#define	SDMMC_USER_DATA_PART_SIZE	(350*1024*1024)	
