...
#define LCD_WIDTH		1024	//1366
#define LCD_HEIGHT		600	//766

void LCD_Initialize_NONAME1(int flag)
{
	u32 uFbAddr = CFG_LCD_FBUFFER;
...
/*******************************************************************/
	...
	Outp32(0xf8000040, 0x0);
	Outp32(0xf8000044, 0x2aaaff);//Window 0 Position Control B Register//=//
	Outp32(0xf8000020, 0x802d); //Window 0 Control Register//=//
	Outp32(0xf8000034, 0x1);//Window Shadow Control Register   bit0: enable channel 0
	Outp32(0xf8000020, 0x802d);//=//
	Outp32(0xf8000034, 0x1);
//	Outp32(0xf8000000, 0x257);
//	Outp32(0xf8000000, 0x57); //===> MPLL should be 667 !!!!
	Outp32(0xf8000000, 0x53); //Video Main Control 0 Register
	Outp32(0xf8000010, 0x60400); //Video Time Control 0 Register
	Outp32(0xf80001a4, 0x3); //I80 / RGB Trigger Control Register
/*******************************************************************/	
...
{
	printf("LCD_turnon is called\n");
#if defined(CFG_LCD_TL2796)
	LCD_Initialize_TL2796();
#elif defined(CFG_LCD_NONAME1)
	LCD_Initialize_NONAME1(flag);
#endif
}
