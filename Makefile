...
#CROSS_COMPILE = $(shell pwd)/../arm-2010q1/bin/arm-none-eabi-
endif
ifeq ($(ARCH),i386)
...
#for friendlyelec
LIBS += friendlyelec/libfriendlyelec.o
...
#		cat $(obj)onenand_bl1/$(BOARD)/BL1.bin.padding $(obj)u-boot.bin > $(U_BOOT_ONENAND)
		cat $(obj)sd_fusing/c110.signedBL1_bin $(obj)u-boot.bin > $(U_BOOT_ONENAND)
		dd iflag=dsync oflag=dsync if=$(obj)sd_fusing/c110.signedBL1_bin of=$(obj)u-boot-sd.bin seek=0
		dd iflag=dsync oflag=dsync if=$(obj)u-boot.bin of=$(obj)u-boot-sd.bin seek=8 count=16
		dd iflag=dsync oflag=dsync if=$(obj)u-boot.bin of=$(obj)u-boot-sd.bin seek=56
...
t34h_config :	unconfig
	@$(MKCONFIG) $(@:_config=) arm s5pc11x smdkc110 samsung s5pc110
	@echo "TEXT_BASE = 0xc3e00000" > $(obj)board/samsung/smdkc110/config.mk

t34h_ics_config :	unconfig
	@$(MKCONFIG) $(@:_config=) arm s5pc11x smdkc110 samsung s5pc110
	@echo "TEXT_BASE = 0xc3e00000" > $(obj)board/samsung/smdkc110/config.mk
